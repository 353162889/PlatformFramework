...
public static class DelegateFactory
{
	...
	class Launch_ResourceMgr_ResourceHandler_Event : LuaDelegate
	{
		public Launch_ResourceMgr_ResourceHandler_Event(LuaFunction func) : base(func) { }
		public Launch_ResourceMgr_ResourceHandler_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(Launch.Resource param0)
		{
			func.BeginPCall();
		...
		public void CallWithSelf(Launch.Resource param0)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushObject(param0);
	...
	public static Delegate Launch_ResourceMgr_ResourceHandler(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			Launch.ResourceMgr.ResourceHandler fn = delegate(Launch.Resource param0) { };
			return fn;
		}

		if(!flag)
		{
			Launch_ResourceMgr_ResourceHandler_Event target = new Launch_ResourceMgr_ResourceHandler_Event(func);
			Launch.ResourceMgr.ResourceHandler d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			Launch_ResourceMgr_ResourceHandler_Event target = new Launch_ResourceMgr_ResourceHandler_Event(func, self);
			Launch.ResourceMgr.ResourceHandler d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	class Launch_SchedulerHandler_Event : LuaDelegate
	{
		public Launch_SchedulerHandler_Event(LuaFunction func) : base(func) { }
		public Launch_SchedulerHandler_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public static Delegate Launch_SchedulerHandler(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			Launch.SchedulerHandler fn = delegate(float param0) { };
			return fn;
		}

		if(!flag)
		{
			Launch_SchedulerHandler_Event target = new Launch_SchedulerHandler_Event(func);
			Launch.SchedulerHandler d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
